...
//        Map<String, String> keyMap = CustomRSAUtil.createKeys(1024);
...
//        String encodedData = CustomRSAUtil.publicEncrypt(str, CustomRSAUtil.getPublicKey(publicKey));
//        System.out.println("密文：\r\n" + encodedData);
//        String decodedData = CustomRSAUtil.privateDecrypt(encodedData, CustomRSAUtil.getPrivateKey(privateKey));
